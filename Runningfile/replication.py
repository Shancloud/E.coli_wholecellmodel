...
def mergefigure9(path, exportpath):
    ...
    for pathx in path:
        ...
        replication_data_file = TableReader(pathx + "ReplicationData")
        ...
        # Load dna mass data
        massFile = TableReader(pathx + "Mass")
        ...
        unique_molecule_counts_reader = TableReader(pathx + "UniqueMoleculeCounts")
    ...
    plt.savefig(exportpath + 'replication.pdf')
