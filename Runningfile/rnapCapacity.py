...
def mergefigure12(path, exportpath):
    ...
    for pathx in path:
        ...
        rnap_reader = TableReader(os.path.join(pathx, "RnapData"))
        ...
        total_rnap_capacity_axis.plot(
            ...
            label="Theoretical total RNAP rate", linewidth=2)
        total_rnap_capacity_axis.plot(
        ...
        active_rnap_capacity_axis.plot(
            ...
            label="Theoretical active RNAP rate", linewidth=2)
        active_rnap_capacity_axis.plot(
            time / 60., actual_elongation_rate,
            label="Actual elongation rate", linewidth=2)
        ...
        inactive_rnap_capacity_axis.plot(
            ...
            label="Theoretical inactive RNAP rate", linewidth=2)
    ...
    plt.savefig(exportpath + 'rnapCapacity.pdf')
